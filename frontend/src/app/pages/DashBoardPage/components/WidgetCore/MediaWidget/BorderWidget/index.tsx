...
const BorderWidget: React.FC<{}> = () => {
  ...
  const firstColor = (widget.config.content as MediaWidgetContent).borderConfig?.firstColor;
  const secondColor = (widget.config.content as MediaWidgetContent).borderConfig?.secondColor;
